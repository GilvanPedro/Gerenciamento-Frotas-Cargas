...
public class Caminhao extends Veiculo{
    ...
    public Caminhao(int id, String marca, String modelo, String placa, TamanhoCaminhao tamanho, boolean veiculoAutomatico, double combustivelMaximo, double peso, double quilometroPorLitro) {
