...
public class Caminhao extends VeiculoCarga {
    ...
    // Construtor padrão sem o id para gerar o caminhao inicial, posteriormente, ele será adicionado no banco de dados, e pegará o id automático dele de lá
    public Caminhao(String marca, String modelo, String placa, boolean automatico, double combustivelMaximo, double peso, double kmPorLitro) {
